...
ros_study/src/ur_moveit_demo.cpp. This file remains as a small
...
class MoveItDemoReference(Node):
    def __init__(self):
        ...
        self.get_logger().info(
            'Example: `ros2 launch ros_study ur5e_bringup_with_mock_components.launch.py launch_moveit:=true`'
        )
        self.get_logger().info('Use `ros2 run ros_study ur_moveit_demo_cpp` for the MoveIt2 planning demo.')
